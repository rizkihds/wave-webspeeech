...
<section id="testimonials">
    <div class="relative flex items-center justify-center pt-24 pb-12 sm:pt-32 bg-zinc-100 md:pb-32 lg:pb-64 min-w-screen">
        <div class="max-w-6xl px-10 pb-20 mx-auto bg-zinc-100">
            <div class="flex flex-col items-center lg:flex-row">
                <div class="flex flex-col justify-center w-full h-full mb-10 lg:pr-8 sm:w-4/5 md:items-center lg:mb-0 lg:items-start md:w-3/5 lg:w-1/2">
                    ...
                    <div class="overflow-hidden rounded-full">
                        <x-button href="#_" tag="a" size="xl" class="w-full md:w-auto">
                ...
                <div class="w-full sm:w-4/5 lg:w-1/2">
                    <blockquote class="flex flex-row-reverse items-center justify-between w-full col-span-1 p-6 bg-white shadow rounded-xl md:flex-row">
                        <div class="flex flex-col pl-5 md:pr-8">
                            <div class="relative md:pl-12">
                                <svg class="absolute left-0 hidden w-10 h-10 text-blue-500 fill-current md:block"
                            ...
                            <h3 class="mt-3 text-base font-medium leading-5 truncate text-zinc-800 md:pl-12">Jane Cooper <span
                    ...
                    <blockquote
                        class="flex flex-row-reverse items-center justify-between w-full col-span-1 p-6 my-5 bg-white rounded-lg shadow md:flex-row">
                        <div class="flex flex-col pl-5 md:pr-10">
                            ...
                            <h3 class="mt-3 text-base font-medium leading-5 truncate text-zinc-800 md:pl-12">John Doe <span
                                    class="mt-1 text-sm leading-5 truncate text-zinc-500">- CEO SomeCompany</span></h3>
                            <p class="mt-1 text-sm leading-5 truncate text-zinc-500"></p>
                        </div>
                        <img class="flex-shrink-0 w-24 h-24 rounded-full bg-zinc-300"
                    ...
                    <blockquote
                        class="flex flex-row-reverse items-center justify-between w-full col-span-1 p-6 bg-white rounded-lg shadow md:flex-row">
                        <div class="flex flex-col pl-5 md:pr-10">
                            <div class="relative md:pl-12">
                                <svg class="absolute left-0 hidden w-10 h-10 text-blue-500 fill-current md:block"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 125">
                            ...
                            <h3 class="mt-3 text-base font-medium leading-5 truncate text-zinc-800 md:pl-12">John Smith <span
                                    class="mt-1 text-sm leading-5 truncate text-zinc-500">- CEO SomeCompany</span></h3>
                            <p class="mt-1 text-sm leading-5 truncate text-zinc-500"></p>
                        </div>
                        <img class="flex-shrink-0 w-24 h-24 rounded-full bg-zinc-300"
